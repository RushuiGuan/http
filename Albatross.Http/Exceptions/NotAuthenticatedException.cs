...
namespace Albatross.Http.Exceptions {
	/// <summary>
	/// A <c>401</c> HTTP error response. Derives from <see cref="Albatross.Exceptions.NotAuthenticatedException"/>
	...
	public class NotAuthenticatedException<T> : Albatross.Exceptions.NotAuthenticatedException, IServiceException {
		...
		public NotAuthenticatedException(HttpMethod method, Uri endpoint, T? errorObject)
			: base(IServiceException.BuildMessage(Albatross.Exceptions.NotAuthenticatedException.StatusCode, method, endpoint)) {
