...
namespace Albatross.Http.Exceptions {
	/// <summary>
	/// A <c>409</c> HTTP error response. Derives from <see cref="Albatross.Exceptions.ConflictException"/>
	...
	public class ConflictException<T> : Albatross.Exceptions.ConflictException, IServiceException {
		...
		public ConflictException(HttpMethod method, Uri endpoint, T? errorObject)
			: base(IServiceException.BuildMessage(Albatross.Exceptions.ConflictException.StatusCode, method, endpoint)) {
