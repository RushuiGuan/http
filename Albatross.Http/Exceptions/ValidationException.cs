...
namespace Albatross.Http.Exceptions {
	...
	public class ValidationException<T> : Albatross.Exceptions.ValidationException, IServiceException {
		...
		public ValidationException(HttpMethod method, Uri endpoint, T? errorObject)
			: base(IServiceException.BuildMessage(Albatross.Exceptions.ValidationException.StatusCode, method, endpoint)) {
